...
const ContentRightCard = () => {
  return (
     ...
     <h2 className="bg-white rounded-full  text-xl font-bold h-12 w-12 flex  justify-center items-center">1</h2>
     <div>
...
<div className="flex justify-between"><button className="bg-black text-white font-medium px-8 py-2 rounded-full text-lg">Hot Problem</button>
